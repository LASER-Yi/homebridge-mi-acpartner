...
let defaultValue = presets.default;
let globalValue = presets.extra;
let tempera_offset = 0;

module.exports = function (plat,model, pw, md, tp, sw, rot, li) {
  let code;
  ...
  code = code.replace(/_li/g, li.toLowerCase());
